SELECT providers.provider_name AS "Имя поставщика", details.detail_name AS "Название детали", projects.project_name AS "Имя проекта", supplies.supplies_quantity AS "Размер поставки"
FROM supplies 
